...
namespace config {
  ...
  const auto kParentTipset{
      "12209139839e65fabea9efd230898ad8b574509147e48d7c1e87a33d6da70fd2efbf"_unhex};
  const std::vector<std::vector<uint8_t>> kParentTipsetBlocks{
      "12209139839e65fabea9efd230898ad8b574509147e48d7c1e87a33d6da70fd2efbf"_unhex,
      "12209139839e65fabea9efd230898ad8b574509147e48d7c1e87a33d6da70fd2efbf"_unhex};
  const std::string kPostProof{"pruuf"};
  const std::vector<uint8_t> kPostRand{
      ...
      "c520d7cfd2cfd4c120d720d7cfccdbc5c2ced9ca20cdc9d2"_unhex};
  const std::vector<uint8_t> kTicket{
      ...
      "66303030303030307672662070726f6f6630303030303030"_unhex};
}  // namespace config
...
class BlockProducerTest : public testing::Test {
 protected:
  ...
  CID decodeCID(const std::vector<uint8_t> &data) const;

  Address getAddress(uint64_t id) const;

  Tipset getParentTipset() const;

  EPostProof getEPostProof() const;
